        ...
        <div className="inline-flex w-full">
            <div>
                ...
                >
                    ...
                    <select className='border border-green-700 outline-1 focus:outline-none p-2 bg-white rounded-lg mx-2' value={selectedColumn} onChange={(e) => setSelectedColumn(e.target.value as 'X' | 'Y')}>
            ...
            <div className="border border-black w-[50%] h-[200px]">
